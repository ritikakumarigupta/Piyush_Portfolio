  ...
  return (
    <footer className="relative bg-[#050508] border-t border-white/10 pt-16 pb-10 overflow-hidden text-neutral-400 font-sans">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* MASSIVE GIGANTIC TYPOGRAPHY: "PIYUSH" (Matching User Screenshot Exactly) */}
        <div className="w-full py-6 sm:py-10 md:py-14 text-center select-none overflow-hidden flex items-center justify-center">
          <h1 className="font-archivo text-[19vw] sm:text-[20vw] md:text-[21vw] lg:text-[22vw] leading-[0.8] font-black uppercase tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-white via-[#EAEAEA] to-[#555555] drop-shadow-[0_10px_50px_rgba(255,255,255,0.22)] hover:scale-[1.01] transition-transform duration-500 cursor-default">
            PIYUSH
          </h1>
        </div>
